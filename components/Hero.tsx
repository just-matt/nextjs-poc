  ...
  return (
    <section className="m-0">
      <div className="w-full max-w-[1260px] mx-auto px-5">
        <div className="relative flex items-center gap-[60px] min-h-[auto] md:min-h-[580px] bg-black text-white rounded-lg overflow-hidden flex-col md:flex-row md:min-h-[580px] md:gap-[60px] px-5">
